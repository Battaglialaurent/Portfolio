# ⚙️ PORTFOLIO TECHNIQUE | LAURENT BATTAGLIA
...
* **Digitalisation :** Numérisation topographique (SIG), archivage de précision.

---

## 📽️ FOCUS PROJET : CINÉMATIQUE SIE ELECTRIC
L'animation ci-dessous démontre ma capacité à simuler et valider des mécanismes complexes avant phase de prototypage.
...
## 📂 STRUCTURE DU DÉPÔT
Mon travail est organisé selon les standards de rigueur industrielle :

* 📁 **`/CAO`** : Fichiers sources SolidWorks et exports universels (.STEP).
* 📁 **`/Documentation`** : Notes de calcul, nomenclatures et analyses de valeur.
* 📁 **`/Mises-en-plan`** : Dossiers de définition conformes aux normes ISO.
* 📄 **`index.html`** : Interface visuelle de mon Portfolio (Industrial Premium).

---

## 🛡️ HABILITATIONS & SÉCURITÉ
* ⚡ **B0V / H0V** : Habilitation électrique à jour.
* 🚑 **SST** : Sauveteur Secouriste du Travail certifié.
* 🖥️ **PIX** : Compétences numériques validées (2024).
